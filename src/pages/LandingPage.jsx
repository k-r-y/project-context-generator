...
export default function LandingPage() {
  useSEO({
    ...
    description:
      "Answer targeted questions and get a complete suite of AI-crafted context files for your project: PRD, Architecture, Design, Rules, and Schema — in under 5 minutes.",
    canonical: "/",
  });

  const navigate = useNavigate();
  const { generatedOutputs, projectMeta, user, setUser, setUserProjects } =
    useProjectStore();
  ...
  return (
    ...
    >
      ...
      {showConfig && (
        <FirebaseConfigModal onClose={() => setShowConfig(false)} />
      )}
    </div>
  );
}
